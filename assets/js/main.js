...
proj4_desc: "Logo design for a cozy café with a warm and modern visual identity.",
  ...
  about_text: [
    ...
    "Everything starts with a vivid feeling, a new place, a moment worth keeping. Every original is one of a kind.",
...
proj4_desc: "Разработка логотипа для уютного кафе с современной визуальной айдентикой.",
  ...
  about_text: [
    ...
    "Всё начинается с яркого ощущения, нового места, момента который хочется сохранить. Каждый оригинал – в единственном экземпляре.",
