...
proj4_desc: "Logo design for a cozy café with a warm and modern visual identity.",
  ...
  about_text: [
    "I’m Olga Qekkel – a painter and visual artist based in Germany.",
    "My work spans oil and acrylic painting, digital illustration, and 2D animation. Formally trained in graphic design, self-taught in painting – over ten years of practice guided by curiosity more than rules.",
    "I paint cats with soul, surrealist florals, abstract landscapes, and cherry blossoms. Every original is one of a kind.",
    "Open to brand collaborations: identity, illustration, concept art. Working worldwide."
  ],
    about_cta: "Contact",
    about_tags: [
      "Limited Drops",
...
form_submit: "Send order request",
    ...
    cookie_link: "Google Privacy Policy",
...
proj4_desc: "Разработка логотипа для уютного кафе с современной визуальной айдентикой.",
  ...
  about_text: [
    "Я Ольга Qekkel – художник и визуальный автор, живу в Германии.",
    "Работаю с маслом, акрилом, цифровой иллюстрацией и 2D анимацией. Образование в графическом дизайне, живопись – самостоятельно, больше десяти лет практики.",
    "Пишу котов с характером, сюрреалистические цветы, абстрактные пейзажи и сакуру. Каждый оригинал – в единственном экземпляре.",
    "Открыта для брендовых коллабораций: айдентика, иллюстрация, концепт-арт. Работаю по всему миру."
  ],
    about_cta: "Связаться",
    store_title: "Магазин",
...
send_email: "Через Email",
    ...
    cookie_link: "Политика конфиденциальности Google",
